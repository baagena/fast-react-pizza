        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="w-full rounded-full px-4 py-2 text-sm transition-all duration-300 placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-4"
            />
          </div>
        </div>
